...
*/
class RXCONTROLSDK_IMPEXP rxInterpolator
{
public:
	/**
	...
	*/
	rxInterpolator(int type, double t0, double tf, const dVector& initial, const dVector& final);
	...
	* @param final final boundary condition of dim. 3, i.e. (pos, vel, acc)
	*/
	void reconfigure(int type, double t0, double tf, const dVector& initial, const dVector& final);
